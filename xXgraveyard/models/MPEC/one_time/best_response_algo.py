...
from xXgraveyard.models.MPEC.one_time.OneScenario.MPEC import MPECModel
from xXgraveyard.models.MPEC.one_time.OneScenario.economic_dispatch import EconomicDispatchModel
from xXgraveyard.models.MPEC.one_time.OneScenario.utilities.diagonalization_loader import load_diagonalization
...
class BestResponseAlgorithm:
    ...
    def solve_strategic_player_problem(self, player_id: int) -> Tuple[List[float], float]:
        ...
        Tuple[List[float], float]
            Optimal bids for all generators controlled by the player
...
if __name__ == "__main__":
    from xXgraveyard.scenario_generation.base_case.scenarios.scenario_generator import ScenarioManager
